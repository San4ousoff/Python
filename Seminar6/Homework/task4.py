# Задание 2 из Семинара 3 (применение zip())
...
# Применение zip() и сокращение кода
l = ceil(len(lst)/2)
diff = [a*b for a, b in zip(lst, lst[::-1])][:l]
print('Произведение пар чисел списка с применением zip(): ' , end='')
print(*diff)